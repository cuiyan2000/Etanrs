...
class UserAETrainer(BaseTrainer):
    ...
    def fit_adv(self, data_tensor, epoch_num, unroll_steps,n_fakes, target_items):
            import higher
            ...
            with higher.innerloop_ctx(model, optimizer) as (fmodel, diffopt):
                ...
                fmodel.eval()
                # all_preds = list()
                # for batch_idx in minibatch(np.arange(n_rows),batch_size=batch_size):
                predictions= fmodel(data_tensor,predict=True)
